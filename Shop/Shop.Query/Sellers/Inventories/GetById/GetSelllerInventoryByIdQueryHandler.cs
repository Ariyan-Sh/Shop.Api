...
{
    internal class GetSelllerInventoryByIdQueryHandler : IQueryHandler<GetSelllerInventoryByIdQuery, InventoryDto?>
    {
        private readonly DapperContext _context;

        public GetSelllerInventoryByIdQueryHandler(DapperContext context)
        {
            _context = context;
        }

        public async Task<InventoryDto?> Handle(GetSelllerInventoryByIdQuery request, CancellationToken cancellationToken)
        {
