...
namespace Shop.Infrastructure.Persistent.Ef.OrderAgg
{
    internal class OrderConfiguration : IEntityTypeConfiguration<Order>
    {
        public void Configure(EntityTypeBuilder<Order> builder)
        {
            ...
            builder.OwnsOne(b => b.Discount, option =>//برای value objects ما دیگه از totable استفاده نمیکنیم
            {
            ...
            builder.OwnsOne(b => b.ShippingMethod, option =>//برای value objects ما دیگه از totable استفاده نمیکنیم
            {
